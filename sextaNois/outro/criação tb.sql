...
PRIMARY KEY ( id ) ,
UNIQUE INDEX descricao_UNIQUE ( descricao ASC) ,
CONSTRAINT `fk_grp_id` FOREIGN KEY (`fk_grp_id`) REFERENCES `tb_grp` (`id`) ,
CONSTRAINT `fk_prof_id` FOREIGN KEY (`fk_prof_id`) REFERENCES `tb_prof` (`id`)
)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS tb_quest (
    ...
    INDEX fk_aluno_has_perg_aluno1 (aluno_id ASC),
